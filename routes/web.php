...
Route::middleware(['auth:tpmf,dekan,wadek', 'checkRole:tpmf,dekan,wadek'])->group(function () {
...
Route::middleware(['auth:gpm,dekan,wadek', 'checkRole:gpm,dekan,wadek'])->group(function () {
