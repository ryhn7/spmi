...
<section class="sectionSize bg-white"> 
    ...
    <div class="container">
        ...
        <div class="container-fluid mt-10 mx-auto">
            <div class="select-none rounded-lg border border-gray-100 p-6 shadow-lg ">
                <div class="card card-primary">
                    <h3 class="text-l font-open font-bold text-center mb-2">Survei Kepuasan Dosen Terhadap Pengelolaan Sumber Daya Manusia</h3>
            ...
            <div class="card-body">
                <table style="width: 100%;" id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @for ($i = 5; $i <= 9; $i++)
                        <tr>
                            <td class="border border-black text-center" style="width: 5%;">{{ $i-4}}.</td>
                            <td class="border-b border-black text-left px-3 py-3">{{ $hasil->{$i} }}</td>
                            @for ($j = 0; $j <= 3; $j++)
                            <td class="border-b border-black text-center">
                                {{ $results[$j]['Total'][$i] }}</td>
        ...
        <div class="container-fluid mt-10 mx-auto">
            <div class="select-none rounded-lg border border-gray-100 p-6 shadow-lg ">
                <div class="card card-primary">
                    <h3 class="text-l font-open font-bold text-center mb-2">Survei Kepuasan Dosen Terhadap Layanan Pengembangan Karir/Jabatan</h3>
            ...
            <div class="card-body">
                <table style="width: 100%;" id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @for ($i = 10; $i <= 16; $i++)
                        <tr>
                            <td class="border border-black text-center" style="width: 5%;">{{ $i-9}}.</td>
                            <td class="border-b border-black text-left px-3 py-3">{{ $hasil->{$i} }}</td>
                            @for ($j = 0; $j <= 3; $j++)
                            <td class="border-b border-black text-center">
                                {{ $results[$j]['Total'][$i] }}</td>
        ...
        <div class="container-fluid mt-10 mx-auto">
            <div class="select-none rounded-lg border border-gray-100 p-6 shadow-lg ">
                <div class="card card-primary">
                    <h3 class="text-l font-open font-bold text-center mb-2">Survei Kepuasan Dosen Terhadap Layanan Penelitian dan Karya Ilmiah</h3>
        ...
        <div class="container-fluid mt-10 mx-auto">
            <div class="select-none rounded-lg border border-gray-100 p-6 shadow-lg ">
                <div class="card card-primary">
                    <h3 class="text-l font-open font-bold text-center mb-2">Survei Kepuasan Dosen Terhadap Layanan Pengabdian kepada Masyarakat</h3>
            ...
            <div class="card-body">
                <table style="width: 100%;" id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @for ($i = 25; $i <= 31; $i++)
                        <tr>
                            <td class="border border-black text-center" style="width: 5%;">{{ $i-24}}.</td>
                            <td class="border-b border-black text-left px-3 py-3">{{ $hasil->{$i} }}</td>
                            @for ($j = 0; $j <= 3; $j++)
                            <td class="border-b border-black text-center">
                                {{ $results[$j]['Total'][$i] }}</td>
        ...
        <div class="container-fluid mt-10 mx-auto">
            <div class="select-none rounded-lg border border-gray-100 p-6 shadow-lg ">
                <div class="card card-primary">
                    <h3 class="text-l font-open font-bold text-center mb-2">Survei Kepuasan Dosen Terhadap Layanan Keuangan, Sarana dan Prasarana</h3>
            ...
            <div class="card-body">
                <table style="width: 100%;" id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @for ($i = 31; $i <= 40; $i++)
                        <tr>
                            <td class="border border-black text-center" style="width: 5%;">{{ $i-30}}.</td>
                            <td class="border-b border-black text-left px-3 py-3">{{ $hasil->{$i} }}</td>
                            @for ($j = 0; $j <= 3; $j++)
                            <td class="border-b border-black text-center">
                                {{ $results[$j]['Total'][$i] }}</td>
