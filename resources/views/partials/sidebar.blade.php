    ...
    <aside
        ...
        <div class="h-19.5">
            <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700">
                <img src="{{ asset('assets/img/logo-undip.png') }}"
                    class="inline h-full mb-1.5 max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
                <span class="ml-1 self-center text-lg whitespace-nowrap">SPMI - FSM</span>
            </a>
        </div>
