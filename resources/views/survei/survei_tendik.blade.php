            ...
            <div class=" border rounded-lg px-8 py-6 mx-auto mb-8 max-w-6xl md:flex-1">
                <form action="/surveiTendik" method="POST">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">1. Fakultas Sains dan Matematika memfasilitasi
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">2. Dukungan pengembangan diri untuk mengikuti
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">3. Dukungan pengembangan diri untuk mengikuti
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">4. Dukungan dan kesempatan untuk mengikuti
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">5. Dukungan dan kesempatan untuk mengikuti
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">6. Mendapat informasi tentang jenjang
                            karir</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">7. Layanan yang diberikan Fakultas Sains dan
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">8. Dukungan dan kesempatan untuk meningkatkan
                            jenjang karir</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">9. Mendapatkan informasi tentang
                            jabatan</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">10. Layanan yang diberikan Fakultas Sains dan
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">11. Dukungan dan kesempatan untuk peningkatan
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">12. Dukungan dan kesempatan untuk peningkatan
