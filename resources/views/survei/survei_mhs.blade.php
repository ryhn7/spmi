    ...
    @if ($surveys === null)
        <div class="pt-32">
            ...
            <form action="/surveiMhs" method="POST">
                ...
                @php
                    $jumlahPertanyaan = 45; // jumlah pertanyaan
                    $namaFor = ['satu', 'dua', 'tiga', 'empat', 'lima', 'enam', 'tujuh', 'delapan', 'sembilan', 'sepuluh', 'sebelas', 'dua_belas', 'tiga_belas', 'empat_belas', 'lima_belas', 'enam_belas', 'tujuh_belas', 'delapan_belas', 'sembilan_belas', 'dua_puluh', 'dua_satu', 'dua_dua', 'dua_tiga', 'dua_empat', 'dua_lima', 'dua_enam', 'dua_tujuh', 'dua_delapan', 'dua_sembilan', 'tiga_puluh', 'tiga_satu', 'tiga_dua', 'tiga_tiga', 'tiga_empat', 'tiga_lima', 'tiga_enam', 'tiga_tujuh', 'tiga_delapan', 'tiga_sembilan', 'empat_puluh', 'empat_satu', 'empat_dua', 'empat_tiga', 'empat_empat', 'empat_lima']; // id untuk setiap pertanyaan
                    $nilaiOptions = ['Sangat Baik', 'Baik', 'Cukup', 'Kurang']; // option yang ada pada setiap pertanyaan
                    $sections = [
                        1 => 'Survei Kepuasan Terkait Keandalan (Reliability)',
                        8 => 'Survei Kepuasan Terkait Daya Tanggap (Responsiveness)',
                        12 => 'Survei Kepuasan Terkait Kepastian (Assurance)',
                        17 => 'Survei Kepuasan Terkait Empati (Empathy)',
                        21 => 'Survei Kepuasan Terkait Tangible',
                        27 => 'Survei Kepuasan Terkait Ketersediaan Layanan Mahasiswa',
                        32 => 'Survei Kepuasan Terkait Proses Belajar Mengajar',
