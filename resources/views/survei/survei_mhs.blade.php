        ...
        <div class="pt-32">
            <div class=" border rounded-lg px-8 py-6 mx-auto mb-8 max-w-6xl md:flex-1 ">
                ...
                <form action="/surveiMhs" method="POST">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">2. Ketepatan Waktu Pelaksanaan
                            Perkuliahan</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);">
                        <label class="block text-gray-700 font-medium mb-2">4. Kesesuaian Keahlian Dosen Mengajar sesuai
                            Bidang
                            Keahliannya</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">6. Kualitas Layanan Staf Akademik untuk
                            Memenuhi
                    ...
                    <label class="block text-2xl font-medium mb-2 flex justify-center items-center">Survei Kepuasan Terkait
                        Daya Tanggap (Responsiveness)</label>
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">9. Kecepatan Dosen dan Karyawan dalam
                            Menanggapi
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">10. Kecepatan dalam memberikan
                            Pelayanan</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">16. Penerapan Sanksi bagi Mahasiswa yang
                            Melanggar
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">18. Proses Monitoring terhadap Kemajuan
                            Mahasiswa
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">19. Kesediaan Dosen dalam Membantu Mahasiswa
                            yang
                    ...
                    <label class="block text-2xl font-medium mb-2 flex justify-center items-center">Survei Kepuasan Terkait
                        Tangible</label>
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">21. Kerapian dan Kebersihan Ruang
                            Kuliah</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">22. Ketersediaan Ruang
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">25. Ketersediaan Fasilitas Ibadah, Kamar Kecil
                            yang
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">26. Ketersediaan Tempat Parkir yang
                            Luas</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <label class="block text-2xl font-medium mb-2 flex justify-center items-center">Survei Kepuasan Terkait
                        Ketersediaan Layanan Mahasiswa </label>
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">28. Ketersediaan Layanan Bimbingan
                            Akademik</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">29. Ketersediaan Layanan Konsultasi untuk
                            Orang
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">31. Ketersediaan Layanan Asuransi untuk
                            Mahasiswa
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">33. Penyampaian Referensi yang diperlukan di
                            Awal
                            Perkuliahan</label>
                        <div class="flex flex-wrap -mx-2 ">
                            <div class="px-2 w-1/4">
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">35. Proses Penilaian didiskusikan dengan
                            Mahasiswa
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">40. Penyampaian Pesan Moral, Etika dan
                            Disiplin
                    ...
                    <div class="mb-4 border border-black rounded px-2" style="border: 1px solid rgba(0, 0, 0, 0.3);"">
                        <label class="block text-gray-700 font-medium mb-2">45. Kesempatan untuk Melakukan Banding atas
                            Nilai
