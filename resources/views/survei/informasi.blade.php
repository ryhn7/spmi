<section id="informasi-survei" class="bg-[#1f2f5f] text-white sectionSize">
    <div>
    ...
    <div class="flex flex-col md:flex-row">
        <div class="flex-1 mx-8 flex flex-col items-center my-4">
            <p class="text-justify font-open">
                Tim Penjaminan Mutu Fakultas Sains dan Matematika menyelenggarakan survei kepuasan pengguna dengan tujuan: <br>
                ...
                Kegiatan survei kepuasan pengguna dilakukan dengan membagikan kuesioner kepada dosen, tenaga kependidikan, mahasiswa, mitra kerjasama dan pengguna lulusan sebagai responden. 
                Kuesioner diterbitkan oleh Tim Penjaminan Mutu Fakultas Sains dan Matematika Universitas Diponegoro. 
                Analisis deskriptif data hasil survey dilakukan untuk mendapatkan perspektif dari setiap aspek yang diukur. <br><br>
                ...
                3. Mekanisme: Pengisian kuesioner dilaksanakan dengan mudah, secara online yang bisa diakses kapan saja dan dimana saja pada periode pengisian.<br>
                4. Pembagian kuesioner kepuasan pengguna kepada dosen, tenaga kependidikan, mahasiswa, mitra kerjasama dan pengguna lulusan.<br> <br>
                Data skor survei kepuasan dosen, tenaga kependidikan, mahasiswa, mitra kerjasama dan pengguna lulusan untuk setiap aspek kualitas layanan diolah untuk memperoleh tingkat kepuasan rata - ratanya. 
                Berikutnya dihitung indeks kepuasan pengguna dengan menghitung grand mean (rerata dari rata - rata). <br><br>
                Indeks kepuasan pengguna ditentukan berdasarkan rentang skor seperti yang ditunjukkan pada tabel berikut:<br> <br> 
                ...
                Untuk melihat kriteria pencapaian responden berdasarkan sifat tertentu, maka diperlukan gambaran terhadap Indeks Tingkat Capaian Responden. 
                Oleh karena itu dalam setiap penelitian selalu membuat “Master Scale” yaitu suatu skala pengukuran yang pada umumnya menunjukkan lima tingkatan sesuatu sifat rertentu. <br><br>
