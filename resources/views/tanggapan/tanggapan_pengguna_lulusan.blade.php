    ...
    <section class="sectionSize bg-white">
        <div><br><br>
            ...
            @if (Auth::guard('gpm')->check())
                ...
                <br>
                <a href="{{ route('tanggapanpenggunalulusan.edit', ['id' => $feedbackGpm->ID]) }}"
                    class="flex items-center p-3 text-base text-white rounded-lg bg-[#1f2f5f] hover:bg-[#324c99] group hover:shadow">
            ...
            <table class="shadow-lg bg-white">
                <tr>
                    <th class="bg-[#03051e] border border-white text-white text-center py-3" style="width: 5%;">No.</th>
                    <th class="bg-[#03051e] border border-white text-white text-center py-3" style="width: 30%;">Pernyataan</th>
                    <th class="bg-[#03051e] border border-white text-white text-center py-3" style="width: 30%;">Tanggapan GPM</th>
                    <th class="bg-[#03051e] border border-white text-white text-center py-3" style="width: 30%;">Tanggapan Dekan</th>
                </tr>
