...
@section('container')
    <div class="pt-32">
        ...
        <form action="{{ route('tanggapanmitra.update', $feedback->ID ) }}" method="POST" enctype="multipart/form-data" onsubmit="return validateWordCount();">
            @csrf
    ...
    <script>
        function validateWordCount() {
            var inputs = ['satu', 'dua', 'tiga', 'empat', 'lima', 'enam', 'tujuh', 'delapan', 'sembilan', 'sepuluh'];
